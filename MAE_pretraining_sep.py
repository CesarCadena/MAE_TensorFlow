...
optimizer_red=tf.train.AdamOptimizer(learning_rate=1e-6,
...
optimizer_green=tf.train.AdamOptimizer(learning_rate=1e-6,
                                      beta1=0.9,beta2=0.999,
                                      epsilon=1e-8,use_locking=False,
...
optimizer_blue=tf.train.AdamOptimizer(learning_rate=1e-5,
                                      beta1=0.9,beta2=0.999,
                                      epsilon=1e-8,use_locking=False,
...
loss_depth_t=loss_depth+1e-2*regularization_depth

optimizer_depth=tf.train.AdamOptimizer(learning_rate=1e-4,
                                      beta1=0.9,beta2=0.999,
                                      epsilon=1e-8,use_locking=False,
...
optimizer_Ground=tf.train.AdamOptimizer(learning_rate=1e-6,
                                      beta1=0.9,beta2=0.999,
                                      epsilon=1e-8,use_locking=False,
...
optimizer_Objects=tf.train.AdamOptimizer(learning_rate=1e-6,
                                      beta1=0.9,beta2=0.999,
                                      epsilon=1e-8,use_locking=False,
...
optimizer_Building=tf.train.AdamOptimizer(learning_rate=1e-6,
                                      beta1=0.9,beta2=0.999,
                                      epsilon=1e-8,use_locking=False,
...
optimizer_Sky=tf.train.AdamOptimizer(learning_rate=1e-6,
                                      beta1=0.9,beta2=0.999,
                                      epsilon=1e-8,use_locking=False,
...
optimizer_Vegetation=tf.train.AdamOptimizer(learning_rate=1e-6,
                                      beta1=0.9,beta2=0.999,
                                      epsilon=1e-8,use_locking=False,
